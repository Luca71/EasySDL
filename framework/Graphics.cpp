...
namespace EasySDL
{
	...
	bool Graphics::Init()
	{
		...
		mWindow = SDL_CreateWindow(GameConfig::Instance()->winTitle.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
									GameConfig::Instance()->winWidth, GameConfig::Instance()->winHeight, flags);
